# -*- coding: utf-8 -*-
"""
Created on Tue Mar 20 22:27:56 2022
...
def run_strategy():
    ...
    for ticker in tickers:
        ...
        try:
            ...
            ohlc = fetchOHLC(ticker = ticker,interval = "15minute",days = 10)

            ohlc["VWAP"] = ta.vwap(ohlc['high'], ohlc['low'], ohlc['close'], ohlc['volume'])
            ohlc[["stochrsik%","stochrsid%"]] = ta.stochrsi(ohlc['close'])
