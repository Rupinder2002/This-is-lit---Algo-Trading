...
def run_strategy():
    ...
    for ticker in tickers:
        ...
        try:
            ...
            ohlc = fetchOHLC(ticker = ticker,interval = "2minute",days = 6)
            ...
            if ticker not in active_tickers:
                ...
                if order['Order'] == 'buy':
                    ...
                    if ohlc.iloc[-1]['signal'] == 'sell':
                        ...
                        print("Position Squared Off for {} by placing Sell Order".format(ticker))
                ...
                if order['Order'] == 'sell':
                    ...
                    if ohlc.iloc[-1]['signal'] == 'buy':
                        ...
                        ord_df = pd.concat([ord_df,trade])
                        active_tickers.remove(ticker)
                        print("Position Squared Off for {} by placing Buy Order".format(ticker))
...
# =============================================================================
# Deploy the startegy to run every 2 mins
# =============================================================================
while dt.datetime.now().time() <= dt.time(15,25):
    
    try:
        run_strategy()
        time.sleep(120 - time_elapsed)
